...
public class XPathLocator {
    public static void main(String[] args) throws InterruptedException {
        ...
        abTesting.click();
        WebElement paragraph= driver.findElement(By.xpath("/html/body/div[2]/div/div/p"));//we don't use it
        System.out.println(paragraph.getText().trim());
        WebElement elementalSelenium= driver.findElement(By.xpath("//a(contains(text(),'Elemental Selenium')]"));//contains We
