...
//        driver.get("https://www.globalsqa.com/angularJs-protractor/BankingProject/#/login");
        ...
        managerPage.validateAddingCustomerFunctionality(driver, ConfigReader.readProperty("QA_name"), ConfigReader.readProperty("QA_lastName"), ConfigReader.readProperty("QA_postCode"), "Customer added successfully");

        managerPage.validateOpenAccountFunctionality(driver, "Dusica Ricabal", "Dollar", "Account created successfully");

        managerPage.validateCustomerInformationAndDeleteFunctionality("Dusica", "Ricabal", "60169");
    }
